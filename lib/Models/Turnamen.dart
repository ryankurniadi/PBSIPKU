...
class Turnamen{
  ...
  Turnamen({this.id, this.nama, this.img, this.tipe, this.limit, this.host, this.lokasi, this.ket, this.status, this.date, this.kontak, this.level, this.batas, this.pbsi});
